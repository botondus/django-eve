...
from importers import chr, graphics, inventory, stations, attributesandeffects, map, npc
...
for mod in [graphics, chr, stations, inventory, attributesandeffects, map, npc]:
