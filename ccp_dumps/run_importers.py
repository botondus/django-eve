...
from importers import chr, graphics, inventory, station, attributesandeffects, map, npc
...
for mod in [graphics, chr, station, inventory, attributesandeffects, map, npc]:
